...
usuario.nome = 'josé'
usuario.idade = 20
usuario.estado = 'Pernambuco'
console.log(usuario)

// a gente consegue alterar valores dentro de uma variavel(caso de um array e um objetos,por exemplo) usando const. ñ consegue é reatribui ou redeclarar variavel

const nome = 'jose'
nome = 'etivaldo'
console.log(nome) // vai dá erro

// se sabe que o valor da variavel ñ vai alterar entao aconselha-se usar o const
